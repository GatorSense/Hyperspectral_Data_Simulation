...
%   labels_point - instance level label in column vectors
%   bag_number - bag number in column vectors
...
labels_bag = horzcat(labels_bag_1,labels_bag_2);
labels_point = horzcat(labels_point_1,labels_point_2);
